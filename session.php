...
if (isset($session_id) && $session_id !== '') {
    ...
    // Build JSON array of [lat, lon] pairs for Leaflet.
    $mapdata = [];
    ...
    // No session selected — show a default map of Area 51.
    $session_id      = '';
...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/5.3.8/js/bootstrap.bundle.min.js"></script>
        <script type="text/javascript" src="static/js/jquery.peity.min.js"></script>
        <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/chosen/1.8.7/chosen.jquery.min.js"></script>
        <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/leaflet/1.9.4/leaflet.min.js"></script>
        ...
        <script type="text/javascript">
          document.addEventListener('DOMContentLoaded', function () {
            ...
            // Fit map to the GPS track bounds
            ...
            <?php } else { ?>
            // No session — centre on Area 51 with a marker
            map.setView(path[0], 16);
            L.marker(path[0]).addTo(map)
              .bindPopup(
                '<div class="alert alert-info" style="margin:0">' +
                '<p class="lead" style="text-align:center;margin:0">' +
                "You're seeing this because<br>you haven't selected a session.<br><br>" +
        ...
        <script type="text/javascript" src="static/js/jquery.flot.hiddengraphs.js"></script>
        <script type="text/javascript" src="static/js/jquery.flot.multihighlight-delta.js"></script>
        ...
        <script type="text/javascript" src="static/js/jquery.flot.updater.js"></script>
        ...
        <script type="text/javascript" src="static/js/torquehelpers.js"></script>
